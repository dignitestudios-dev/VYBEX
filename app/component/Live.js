...
export const Live = () => {
  return (
    <div className="flex items-center justify-center p-4 md:py-24">
      <div className="lg:w-[95%]  border-[1px] border-[#252530AB]   rounded-[30px] bg-gradient-to-br from-40% from-[#040818]  via-75% via-[#0000FE] to-100% to-[#D0090B] md:h-[420px] grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 justify-center  p-8    md:gap-20  ">
        ...
        <div className="relative -top-28   lg:flex justify-center hidden ">
          <Image src={livemockup} alt="" className="h-[680px] w-[500px]" />
        </div>
