  ...
  return (
    <div className="heroimge bg-[#040818]  text-white   ">
      ...
      <div className="  p-22 ">
        ...
        <p className="mb-4">
          Vybex (“we,” “our,” or “us”) is committed to protecting your privacy.
          This Privacy Policy explains how your personal information is
          collected, used, and disclosed by Vybex .
        </p>
        <p className="mb-4">
          ...
          Vybex . By accessing or using our Service, you signify that you have
        ...
        <ul className="list-disc pl-6 mb-4">
          ...
          <li>
            ...
            mentions “Company,” “we,” “us,” or “our,” it refers to Vybex LLC,
            (4250 W 1st Apt 201. Santa Ana, CA, 92703), that is responsible for
            your information under this Privacy Policy.
          </li>
          <li>
            <span className="font-semibold"> Country:</span> where Vybex or the
            owners/founders of Vybex are based, in this case is United States.
          </li>
          <li>
            <span className="font-semibold"> Customer:</span> refers to the
            company, organization or person that signs up to use the Vybex
          ...
          <li>
            ...
            device that can be used to visit Vybex and use the services.
          </li>
          <li>
          ...
          <li>
            ...
            individuals who are employed by Vybex or are under contract to
          ...
          <li>
            ...
            service provided by Vybex as described in the relative terms (if
          ...
          <li>
            ...
            is registered with Vybex to use the Services.
          </li>
        </ul>
        ...
        <ul className="list-disc pl-6 mb-4">
          <li>
            <span className="font-semibold">Location (GPS):</span> access to
            your device's GPS data to provide location-based services or
            features.
          </li>
          <li>
            <span className="font-semibold">Camera (Pictures):</span> permission
            to use your device’s camera for capturing photos or videos within
            the app.
          </li>
          <li>
            <span className="font-semibold">Photo Gallery (Pictures):</span>{" "}
            access to your device’s photo library to upload or select media.
          </li>
        </ul>
        <h2 className="text-2xl font-bold mb-2">
          When does Vybex use end user information from third parties?
        </h2>
        <p className="mb-4">
          Vybex will collect End User Data necessary to provide the Vybex
        ...
        <h2 className="text-2xl font-bold mb-2">
          When does Vybex use customer information from third parties?
        </h2>
        <p className="mb-4">
          ...
          interest in becoming a Vybex customer, we receive information from a
          third party that provides automated fraud detection services to Vybex
        ...
        <p className="">
          Vybex will collect personal information that you submit to us. We may
        ...
        <p className="mb-4">
          ...
          unsubscribe option that is included in the respective email.
        </p>
        <p className="mb-4">
        ...
        <p className="">
          <strong>Note:</strong> If at any time you would like to unsubscribe
        ...
        <p className="mb-4">
          We keep your information only so long as we need it to provide Vybex
        ...
        <p className="mb-4">
          When we no longer need to use your information and there is no need
          for us to keep it to comply with our legal or regulatory obligations,
          we’ll either remove it from our systems or depersonalize it so that we
          can't identify you.
        </p>
        <h2 className="text-2xl font-bold mb-2">
        ...
        <p className="mb-4">
          ...
          you transmit to Vybex or guarantee that your information on the
        ...
        <p className="mb-4">
          Vybex is incorporated in United States. Information collected via our
          website/app, through direct interactions with you, or from use of our
        ...
        <h2 className="text-2xl font-bold mb-2 mt-6">
          Is the information collected through the Vybex Service secure?
        </h2>
        <p className="mb-4">
          ...
          correctly use your information.
        </p>
        <p className="mb-4">
          However, neither people nor security systems are foolproof, including
          encryption systems. In addition, people can commit intentional crimes,
        ...
        <p className="mb-4">
          ...
          information, you agree that intentional misconduct will be the
        ...
        <p className="mb-4">
          ...
          information Vybex collects depend on your relationship with Vybex.
        ...
        <p className="mb-4">
          ...
          in databases we actively use, and other readily searchable media will
          be updated, corrected, changed or deleted, as appropriate, as soon as
          and to the extent reasonably and technically practicable.
        </p>
        <p className="mb-4">
        ...
        <h2 className="text-2xl font-bold mt-4 mb-2">Personnel</h2>
        <p className="mt-4">
          If you are a Vybex worker or applicant, we collect information you
        ...
        <h2 className="text-2xl font-bold mt-4 mb-2">Sale of Business</h2>
        <p className="mt-4">
          ...
          of the assets of Vybex or any of its Corporate Affiliates (as defined
          herein), or that portion of Vybex or any of its Corporate Affiliates
        ...
        <h2 className="text-2xl font-bold mt-4 mb-2">Affiliates</h2>
        <p className="mt-4">
          ...
          Vybex, whether by ownership or otherwise. Any information relating to
        ...
        <h2 className="text-2xl font-bold mt-4 mb-2">Governing Law</h2>
        <p className="mt-4">
        ...
        <p className="mt-4">
          By using Vybex or contacting us directly, you signify your acceptance
          of this Privacy Policy. If you do not agree to this Privacy Policy,
          you should not engage with our website/app, or use our services.
          Continued use of the website/app, direct engagement with us, or
        ...
        <h2 className="text-2xl font-bold mt-4 mb-2">Your Consent</h2>
        <p className="mt-4">
          ...
          it's being used. By using our Vybex, registering an account, or making
        ...
        <h2 className="text-2xl font-bold mt-4 mb-2">Advertising</h2>
        <p className="mt-4">
          This website/app may contain third party advertisements and links to
          third party sites. Vybex does not make any representation as to the
        ...
        <p className="mt-4">
          Advertising keeps Vybex and many of the websites and services you use
        ...
        <p className="mt-4">
          ...
          Vybex of the third party sites, goods or services. Vybex takes no
        ...
        <p className="mt-4">
          ...
          our website/app correctly or at all. We never place Personally
        ...
        <p className="mt-4">
          ...
          cookies and prevent our website/app from functioning properly, and you
          may not be able to fully utilize all of its features and services.
        </p>
        <p className="mt-4">
        ...
        <h2 className="text-2xl font-bold mt-4 mb-2">Remarketing Services</h2>
        <p className="mt-4">
          ...
          across the internet to people who have already visited your
          website/app. It allows your company to seem like they're “following”
          people around the internet by serving ads on the websites and
          platforms they use most.
        </p>

        <h2 className="text-2xl font-bold mt-4 mb-2">Payment Details</h2>
        <p className="mt-4">
        ...
        <h2 className="text-2xl font-bold mt-4 mb-2">Kids' Privacy</h2>
        <p className="mt-4">
        ...
        <h2 className="text-2xl font-bold mt-4 mb-2">Third-Party Services</h2>
        <p className="mt-4">
        ...
        <h2 className="text-2xl font-bold mt-4 mb-2">Tracking Technologies</h2>

        <h3 className="text-xl font-semibold mt-4 mb-1">Google Maps API</h3>
        <p className="mt-4">
        ...
        <h3 className="text-xl font-semibold mt-4 mb-1">Local Storage</h3>
        <p className="mt-4">
        ...
        <h3 className="text-xl font-semibold mt-4 mb-1">Sessions</h3>
        <p className="mt-4">
        ...
        <h3 className="text-2xl font-bold mt-4 mb-1">What is GDPR?</h3>
        ...
        <h2 className="text-2xl font-bold mt-4 mb-2">What is personal data?</h2>
        ...
        <h2 className="text-2xl font-bold mt-4 mb-2">Why is GDPR important?</h2>
        ...
        <p className="mt-4">
          ...
          right thing to do. At Vybex we strongly believe that your data privacy
        ...
        <p className="mt-4">
          ...
          requirements of GDPR. Vybex processes or stores all personal data in
        ...
        <h2 className="text-2xl font-bold mt-4 mb-2">California Residents</h2>
        ...
        <p className="mt-4">CalOPPA users have the following rights:</p>
        ...
        <ul className="list-disc pl-5 mt-4 space-y-2">
          ...
          <li>
            <strong>Right to Request:</strong> You may request that a business
