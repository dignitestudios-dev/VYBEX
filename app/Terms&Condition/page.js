  ...
  return (
    <div className="w-full bg-[#040818] ">
      ...
      <div className="text-white leading-relaxed   p-12 space-y-5">
        ...
        <p className="text-lg font-bold mb-8">Updated at April 17th, 2025</p>
        <h2 className="text-3xl font-bold mt-10 mb-2">General Terms</h2>
        <p className=" mb-6">
          By accessing and placing an order with Vybex , you confirm that you
        ...
        <p className=" mb-6">
          Under no circumstances shall Vybex team be liable for any direct,
          ...
          inability to use, the materials on this site, even if Vybex team or an
        ...
        <p className=" mb-6">
          Vybex will not be responsible for any outcome that may occur during
        ...
        <h2 className="text-3xl font-bold mt-10 mb-2">License</h2>
        <p className=" mb-6">
          Vybex grants you a revocable, non-exclusive, non-transferable, limited
          license to download, install and use the website/app strictly in
          accordance with the terms of this Agreement.
        </p>
        <p className=" mb-6">
          These Terms & Conditions are a contract between you and Vybex
          (referred to in these Terms & Conditions as "Vybex ", "us", "we" or
          "our"), the provider of the Vybex website and the services accessible
          from the Vybex website (which are collectively referred to in these
          Terms & Conditions as the "Vybex Service").
        </p>
        <p className=" mb-6">
          You are agreeing to be bound by these Terms & Conditions. If you do
          not agree to these Terms & Conditions, please do not use the Vybex
        ...
        <h2 className="text-3xl font-bold mb-2">Definitions and key terms</h2>
        ...
        <ul className="list-disc pl-6 mb-4 ">
          ...
          <li>
            Country: where Vybex or the owners/founders of Vybex are based, in
            this case is United States
          </li>
          <li>
            Device: any internet connected device such as a phone, tablet,
            computer or any other device that can be used to visit Vybex and use
            the services.
          </li>

          <li>
            CService: refers to the service provided by Vybex as described in
          ...
          <li>
            You: a person or entity that is registered with Vybex to use the
            Services.
          </li>
        </ul>
        <h2 className="text-3xl mb-2 font-bold  ">Restrictions</h2>
        <p className=" mb-2 font-bold ">
        ...
        <ul className="list-disc pl-6 mb-4 ">
          ...
          <li>
            ...
            notice of copyright or trademark) of Vybex or its affiliates,
        ...
        <p className=" ">
          ...
          liabilities with respect to your Payment Provider. By providing Vybex
          with your credit card number and associated payment information, you
          agree that Vybex is authorized to verify information immediately, and
          subsequently invoice your account for all fees and charges due and
          payable to Vybex hereunder and that no additional notice or consent is
          required. You agree to immediately notify Vybex of any change in your
          billing address or the credit card used for payment hereunder. Vybex
          ...
          delivery to your organizationâ€™s administrator(s).
        </p>
        <p className=" ">
        ...
        <p className=" ">
          No contract will exist between you and Vybex for the Service until
          Vybex accepts your order by a confirmatory e-mail, SMS/MMS message, or
        ...
        <h2 className="text-3xl mb-2 font-bold  ">Return and Refund Policy</h2>
        <p className=" ">
          Thanks for shopping at Vybex . We appreciate the fact that you like to
          buy the stuff we build. We also want to make sure you have a rewarding
          experience while youâ€™re exploring, evaluating, and purchasing our
          products.
        </p>
        <p className=" ">
          As with any shopping experience, there are terms and conditions that
          apply to transactions at Vybex . Weâ€™ll be as brief as our attorneys
          will allow. The main thing to remember is that by placing an order or
          making a purchase at Vybex , you agree to the terms along with Vybex
          â€™s Privacy Policy.
        </p>
        <p className=" ">
        ...
        <h2 className="text-3xl mb-2 font-bold  ">Your Suggestions</h2>
        <p>
          Any feedback, comments, ideas, improvements or suggestions
          (collectively, "Suggestions") provided by you to Vybex with respect to
          the website/app shall remain the sole and exclusive property of Vybex.
        </p>
        <p>
          Vybex shall be free to use, copy, modify, publish, or redistribute the
          Suggestions for any purpose and in any way without any credit or any
          compensation to you.
        </p>
        <h2 className="text-3xl mb-2 font-bold ">Your Consent</h2>
        <p>
        ...
        <h2 className="text-3xl mb-2 font-bold ">Links to Other Websites</h2>
        <p>
          This Terms & Conditions applies only to the Services. The Services may
          contain links to other websites not operated or controlled by Vybex.
        ...
        <h2 className="text-3xl mb-2 font-bold  ">Cookies</h2>
        <p>
          Vybex uses "Cookies" to identify the areas of our website/app that you
        ...
        <p>
          ...
          logged in previously. Most web browsers can be set to disable the use
          of Cookies. However, if you disable Cookies, you may not be able to
        ...
        <p>
          You acknowledge and agree that Vybex may stop (permanently or
          temporarily) providing the Service (or any features within the
          Service) to you or to users generally at Vybex’s sole discretion,
          without prior notice to you.
        </p>
        <p>
          You may stop using the Service at any time. You do not need to
          specifically inform Vybex when you stop using the Service. You
          acknowledge and agree that if Vybex disables access to your account,
        ...
        <p>
          Vybex reserves the right to modify, suspend or discontinue,
        ...
        <p>
          Vybex may from time to time provide enhancements or improvements to
        ...
        <p>
          ...
          of the website/app. You agree that Vybex has no obligation to (i)
        ...
        <h2 className="text-3xl mb-2 font-bold ">Third-Party Services</h2>
        <p>
        ...
        <p>
          You acknowledge and agree that Vybex shall not be responsible for any
          ...
          or any other aspect thereof. Vybex does not assume and shall not have
        ...
        <h2 className="text-3xl mb-2 font-bold  ">Term and Termination</h2>
        <p>
          This Agreement shall remain in effect until terminated by you or
          Vybex.
        </p>
        <p>
          Vybex may, in its sole discretion, at any time and for any or no
        ...
        <p>
          ...
          Vybex, in the event that you fail to comply with any provision of this
        ...
        <p>
          Termination of this Agreement will not limit any of Vybex's rights or
        ...
        <p>
          ...
          the material is not authorized by the copyright owners; and
          <br />
        ...
        <h2 className="text-3xl mb-2 font-bold  ">Indemnification</h2>
        <p>
          You agree to indemnify and hold Vybex and its parents, subsidiaries,
        ...
        <h2 className="mb-2 font-bold ">No Warranties</h2>
        <p>
          ...
          extent permitted under applicable law, Vybex, on its own behalf and on
          behalf of its affiliates and their respective licensors and service
          providers, expressly disclaims all warranties—express, implied,
        ...
        <p>
          Without limitation to the foregoing, Vybex provides no warranty or
        ...
        <p>
          Without limiting the foregoing, neither Vybex nor any of Vybex’s
          providers make any representation or warranty of any kind, express or
          implied:
          <br />
          ...
          provided; or
          <br />
          (iv) that the website/app or any content is free of viruses or harmful
          components.
        </p>
        <p>
          Some jurisdictions do not allow limitations on implied warranties or
          consumer rights, so the above may not fully apply to you.
        </p>
        <h2 className="mb-2 font-bold ">Limitation of Liability</h2>
        <p>
          Notwithstanding any damages that you might incur, the entire liability
          of Vybex and any of its suppliers under any provision of this
          Agreement and your exclusive remedy shall be limited to the amount
          actually paid by you for the website/app.
        </p>
        <p>
          To the maximum extent permitted by applicable law, in no event shall
          Vybex or its suppliers be liable for any special, incidental,
          indirect, or consequential damages whatsoever—including but not
          limited to loss of profits, data, business interruption, personal
          injury, loss of privacy—arising out of or in any way related to the
          use of or inability to use the website/app or third-party
          hardware/software used with it.
        </p>
        <p>
        ...
        <h2 className="mb-2 font-bold text-3xl">Severability</h2>
        <p>
        ...
        <p>
          ...
          notices published by Vybex on the Services, shall constitute the
          entire agreement between you and Vybex concerning the Services. If any
          ...
          or any other term, and Vybex â€™s failure to assert any right or
          provision under this Agreement shall not constitute a waiver of such
          right or provision. YOU AND Vybex AGREE THAT ANY CAUSE OF ACTION
        ...
        <h2 className="mb-2 font-bold text-3xl">Waiver</h2>
        <p>
        ...
        <h2 className="mb-2 font-bold text-3xl">Amendments to this Agreement</h2>
        <p>
          Vybex reserves the right, at its sole discretion, to modify or replace
        ...
        <h2 className="mb-2 font-bold text-3xl">Entire Agreement</h2>
        <p>
          This Agreement constitutes the entire agreement between you and Vybex
          regarding your use of the website/app and supersedes all prior and
          contemporaneous written or oral agreements between you and Vybex.
        </p>
        <p>
          You may be subject to additional terms and conditions that apply when
          you use or purchase other Vybex's services, which Vybex will provide
          to you at the time of such use or purchase.
        </p>
        <h2 className="mb-2 font-bold text-3xl">Updates to Our Terms</h2>
        <p>
        ...
        <h2 className="mb-2 font-bold text-3xl">Intellectual Property</h2>
        <p>
          The website/app and its entire contents, features and functionality
          (including but not limited to all information, software, text,
          displays, images, video and audio, and the design, selection and
          arrangement thereof), are owned by Vybex, its licensors or other
          ...
          Vybex, unless and except as is expressly provided in these Terms &
          Conditions. Any unauthorized use of the material is prohibited.
        </p>
        <h2 className="mb-2 font-bold text-3xl">Agreement to Arbitrate</h2>
        <p>
          This section applies to any dispute{" "}
          <strong>
            EXCEPT IT DOESN’T INCLUDE A DISPUTE RELATING TO CLAIMS FOR
            INJUNCTIVE OR EQUITABLE RELIEF REGARDING THE ENFORCEMENT OR VALIDITY
            OF YOUR OR Vybex’s INTELLECTUAL PROPERTY RIGHTS.
          </strong>{" "}
          The term “dispute” means any dispute, action, or other controversy
          between you and Vybex concerning the Services or this agreement,
        ...
        <h2 className="mb-2 font-bold text-3xl">Notice of Dispute</h2>
        <p>
          In the event of a dispute, you or Vybex must give the other a Notice
          ...
          <a
            href="mailto:info@vybexapp.com"
            className="text-blue-600 underline"
          >
            info@vybexapp.com
          </a>
          . Vybex will send any Notice of Dispute to you by mail to your address
          if we have it, or otherwise to your email address. You and Vybex will
          ...
          sixty (60) days, you or Vybex may commence arbitration.
        </p>
        <h2 className="mb-2 font-bold text-3xl">Binding Arbitration</h2>
        <p>
          If you and Vybex don’t resolve any dispute by informal negotiation,
        ...
        <h2 className="mb-2 font-bold text-3xl">Submissions and Privacy</h2>
        <p>
          ...
          and will become the sole property of <strong>Vybex</strong> without
          any compensation or credit to you whatsoever.
          <strong> Vybex</strong> and its affiliates shall have no obligations
        ...
        <h2 className="mb-2 font-bold text-3xl">Promotions</h2>
        <p>
          <strong>Vybex</strong> may, from time to time, include contests,
        ...
        <h2 className="mb-2 font-bold text-3xl">Typographical Errors</h2>
        <p>
        ...
        <h2 className="text-3xl mb-2 font-bold ">Miscellaneous</h2>
        <p>
          ...
          representative of <strong>Vybex</strong>.
        </p>
        <p>
          <strong>Vybex</strong> will be entitled to injunctive or other
        ...
        <p>
          <strong>Vybex</strong> operates and controls the Vybex Service from
          its offices in the United States. The Service is not intended for
          distribution to or use by any person or entity in any jurisdiction or
          country where such distribution or use would be contrary to law or
          regulation. Accordingly, those persons who choose to access the Vybex
        ...
        <p>
          These Terms & Conditions (which include and incorporate the Vybex
          Privacy Policy) contain the entire understanding, and supersede all
          prior understandings, between you and <strong>Vybex</strong>{" "}
        ...
        <h2 className="text-3xl mb-2 font-bold ">Disclaimer</h2>
        <p>
          <strong>Vybex</strong> is not responsible for any content, code or any
          other imprecision.
        </p>
        <p>
          <strong>Vybex</strong> does not provide warranties or guarantees.
        </p>
        <p>
          In no event shall <strong>Vybex</strong> be liable for any special,
        ...
        <p>
          The Vybex Service and its contents are provided "as is" and "as
          available" without any warranty or representations of any kind,
          whether express or implied. <strong>Vybex</strong> is a distributor
          and not a publisher of the content supplied by third parties; as such,
          Vybex exercises no editorial control over such content and makes no
          ...
          or accessible via the Vybex Service.
        </p>
        <p>
          Without limiting the foregoing, <strong>Vybex</strong> specifically
          disclaims all warranties and representations in any content
          transmitted on or in connection with the Vybex Service or on sites
          that may appear as links on the Vybex Service, or in the products
          provided as a part of, or otherwise in connection with, the Vybex
          Service, including without limitation any warranties of
          merchantability, fitness for a particular purpose or non-infringement
          of third party rights.
        </p>
        <p>
          No oral advice or written information given by <strong>Vybex</strong>{" "}
          or any of its affiliates, employees, officers, directors, agents, or
          the like will create a warranty. Price and availability information is
